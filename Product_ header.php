...
{
  $sub=$_POST['sub'];
  $sql_query="SELECT * FROM products where prdct_type=$sub";
                   ...
                   if($result->num_rows > 0)
                   {
                       while($row=$result->fetch_assoc())
                       {
                         ?>
                             ...
                             <intput type="submit" value="<?php echo  $row["cat_name"]; ?>" onsubmit="Multilevel_menu()">
                         </form>
                    ...
                    <dialouge id="dial">
                       <php
                          $sql_query="SELECT * FROM $_SESSION['table'];";
                        $result=$conn->query($sql_query);
