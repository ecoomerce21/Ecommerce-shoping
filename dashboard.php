...
<style>
           ...
           body{
            ...
            background: linear-gradient(95deg ,#433243,#737973);
               margin-top:100px;
               font-weight:900;
...
<body>
    <center>
        <div class="card">
    <h1>E-Commerce platform</h1><br><br>

    <p>You Logout Successfully!<br><a href="login.php">Click Here to Login again</a></p>
