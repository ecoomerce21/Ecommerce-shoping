...
if(isset($_GET["cat_id"]) )
{
   ...
   // Fetch the prdct records According to the category
    ...
    // Fetch the prdct records According to the category 
        $sql_query = "SELECT * FROM product WHERE prdct_cat=$catid  LIMIT $limit OFFSET $offset ;";/*(SELECT cat_id FROM category WHERE cat_name='$catname') LIMIT $limit OFFSET $offset";*/
...
<!--
    ...
    <!-- category section ends -->
      ...
      if($page_no==1)
          {
              $nxt=$page_no+1;
              echo '<a  href="productss.php?cat_id='.$catid.'&pg='.$nxt.'" class="btn btn-primary"  >Next</a>';
          }
      else if($left_rec < 0 )
        {
            $bck=$page_no-1;
            echo '<a  href="productss.php?cat_id='.$catid.'&pg='.$bck.'" class="btn btn-primary"  >Back</a>';
        }
     else
       {
            $nxt=$page_no+1;
            $bck=$page_no-1;
           echo '<a  href="productss.php?cat_id='.$catid.'&pg='.$bck.' " class="btn btn-primary" >Back</a>  <a  href="productss.php?cat_id='.$catid.'&pg='.$nxt.' " class="btn btn-primary">Next</a>';
        }
     }
  ...
  if(isset($_POST["btn_search"]) || isset($_POST["pg_no"]))
   {
    ...
    if($page_no1 ==1)
    {
         ...
         echo ' <a >Previous</a> | <a href="productss.php?pg_no='.$page_no1.'">Next</a>';
    }
  else if($left_rec < 0)
  {

     $last= $page_no1 - 2;
     echo '<a href="productss.php?pg_no='.$last.'">Previous</a> | <a>Next</a>';
  ...
  else
  {
     ...
     echo ' <a href="productss.php?pg_no='.($last).'" >Previous</a> | <a href="productss.php?pg_no='.($page_no1).'">Next</a>';
  }
 }
